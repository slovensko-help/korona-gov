...
function korona_post_type() {
    ...
    $labels = array(
        ...
        'insert_into_item'      => __( '', 'gov' ),
        'uploaded_to_this_item' => __( '', 'gov' ),
        'items_list'            => __( '', 'gov' ),
        'items_list_navigation' => __( '', 'gov' ),
        'filter_items_list'     => __( '', 'gov' ),
    );
    $args = array(
...
function korona_taxonomy() {
    ...
    $labels = array(
        ...
        'update_item'                => __( 'Aktualizovať', 'gov' ),
        'view_item'                  => __( 'Zobraziť', 'gov' ),
        'separate_items_with_commas' => __( '', 'gov' ),
        'add_or_remove_items'        => __( 'Pridať alebo zmazať', 'gov' ),
        'choose_from_most_used'      => __( '', 'gov' ),
        'popular_items'              => __( '', 'gov' ),
