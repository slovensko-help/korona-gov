<?php define('RC_ASSETS_VERSION', '1.0.3'); ?>
...
<!--                    <a href="#" class="js-uc-add-country uc-add-country govuk-link">Nastaviť dnes</a>-->
            ...
            <fieldset class="govuk-fieldset govuk-!-margin-bottom-5" role="group" aria-describedby="uc-personal-data">
                ...
                <div class="govuk-form-group govuk-!-margin-bottom-3">
                    ...
                    <input class="govuk-input govuk-input--width-20" id="uc-last-name-1" name="last-name-1" type="text">
                </div>
                ...
                <div class="govuk-form-group govuk-!-margin-bottom-1">
                    ...
                    <div class="govuk-radios govuk-radios--conditional" data-module="govuk-radios">
                        ...
                        <div class="govuk-radios__conditional govuk-radios__conditional--hidden" id="id-type-conditional-slovak-1">
                            <input class="govuk-input govuk-!-width-one-third" name="id-slovak-1" type="text" id="uc-id-slovak-1">
                        </div>
                        <div class="govuk-radios__item">
                            <input class="govuk-radios__input" id="uc-id-type-1-foreign" name="id-type-1" type="radio" value="foreign" data-aria-controls="id-type-conditional-foreign-1">
            ...
            <fieldset class="govuk-fieldset govuk-!-margin-bottom-5" role="group" aria-describedby="uc-isolation-address">
                ...
                <div class="govuk-form-group govuk-!-margin-bottom-3">
                    <div class="uc-municipality-holder">
                        ...
                        <input type="hidden" name="isolation-municipality" id="municipality-input-uc-isolation-municipality">
                        <input type="hidden" name="isolation-county" id="county-input-uc-isolation-municipality">
                ...
                <div class="govuk-form-group govuk-!-margin-bottom-3">
                    ...
                    <span id="uc-isolation-house-number-error" class="govuk-error-message" style="display: none;">
                              Zadajte číslo domu.
                            </span>
